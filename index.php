    ...
    <header id="header" class="fixed-top">
        ...
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto">
                <a href="index.html"><img src="img/LZR.svg">Lanzara Transportes</a>
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down"><a href="">Consulte</a>
                        <ul>''
                            <li><a href="#contact">Solicitação de Cotação</a></li>
                        </ul>
                    </li>
                    <li class="drop-down"><a href="">Certificações</a>
                        <ul>
                ...
                <div class="carousel-item active" style="background-image: url(assets/img/slide/slide1.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Ver
                                mais </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item" style="background-image: url(assets/img/slide/slide2.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">leia
                                mais
                            </a>
                        </div>
                    </div>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>QUEM SOMOS</h2>
                    <p>Informaçoes sobre a empresa aqui.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        <h3>Um pouci sobre os serviços</h3>
                        <p class="font-italic">
                            Informaçoes aqui
                        </p>
                        <ul>
                            <li><i class="icofont-check-circled"></i> Adiciona informaçoes aqui
                            </li>
                            <li><i class="icofont-check-circled"></i> Adiciona informaçoes aqui .</li>
                            <li><i class="icofont-check-circled"></i> Adiciona informaçoes aqui.</li>
                        </ul>
                        <p>
                            Adiciona informaçoes aqui
                        </p>
                    </div>
                </div>
        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <strong style="font-size: large;">Envie todas as informações e nosso departamento comercial entrará em contato.</strong>
